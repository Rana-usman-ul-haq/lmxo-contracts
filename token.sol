...
contract LMXO is ERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => bool) public _isWhiteListed;
    uint256 public antiWhaleLimit = 500000000 * 10 ** decimals();

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("LMXO", "$LMXO") {
    ...
    function _transfer(
        ...
        if(recipient != uniswapV2Pair){
            require(balanceOf(recipient) + amount <= antiWhaleLimit, "Exceeds the Anti Whale Limit.");
        }
        }
    ...
    function changeAntiWhaleLimits(uint256 _limit) public onlyOwner{
